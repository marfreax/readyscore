...
const cards = [
  ...
  { href: "/trial/eq", label: "EQ", title: "Eksplorasi profil EQ Anda", description: "50 pertanyaan pada empat dimensi EQ." },
  { href: "/trial/disc", label: "DISC", title: "Kenali kecenderungan perilaku Anda", description: "80 pertanyaan pada empat dimensi DISC." },
