...
export async function POST(request: Request) {
  try {
    ...
    const status =
      ...
      code === "PRODUCT_NOT_AVAILABLE" || code === "PRODUCT_PRICE_NOT_CONFIGURED" || code === "SINGLE_TEST_SELECTION_REQUIRED" || code === "INVALID_SINGLE_TEST_TYPE" || code === "INVALID_SINGLE_TEST_SELECTION" ? 409 :
